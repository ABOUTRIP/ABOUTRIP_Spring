//package com.ssafy.project.attraction.aop;
//
...
//
//	@Before(value = "execution(* com.ssafy.project.attraction.model..Board*.*(..))")
...
//	}
//
//	@Around(value = "execution(* com.ssafy.project.attraction.model..Board*.*(..))")
...
//	}
//
//	@AfterReturning(value = "execution(* com.ssafy.project.attraction.model..Board*.list*(..))", returning = "obj")
...
//	}
//
//	@AfterThrowing(value = "execution(* com.ssafy.project.attraction.model..Board*.list*(..))", throwing = "exception")
//	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
//		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
//		logger.debug("exception : {}", exception);
//	}
//
//	@After(value = "execution(* com.ssafy.project.attraction.model..Board*.list*(..))")
