...
public interface PlanMapper {
	...
	public int updateHit(int planno) throws SQLException;
	public int updateLike(int planno) throws SQLException;
	public int modifyPlan(PlanDto planDto) throws SQLException;
//	public void deleteMemo(int planno) throws SQLException;
