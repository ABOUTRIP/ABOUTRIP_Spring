...
public interface PlanService {
	...
	public List<PlanDto> listPlan(BoardParameterDto planParameterDto) throws Exception;
	public PageNavigation makePageNavigation(BoardParameterDto planParameterDto) throws Exception;
