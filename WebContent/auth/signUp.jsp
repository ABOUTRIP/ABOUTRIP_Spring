				...
				<form method="post" action="${root}/UserController">
					...
					<div class="form-outline mb-4">
						<input type="text" id="registerName" class="form-control"
							name="name" /> <label class="form-label" for="registerName">이름</label>
					</div>

					<div class="form-outline mb-4">
						<input type="text" id="registerId" class="form-control" name="id" />
						<label class="form-label" for="registerName">아이디</label>
					</div>
					...
					<div class="form-outline mb-4">
						<input type="email" id="registerId" name="email"
							...
							for="registerName">이메일</label>
					</div>
					<label class="form-label" for="registerName">지역</label>
					<div class="form-outline mb-4">
						<div class="d-flex">
							<select id="sido" class="form-select me-2" name="sido">
								<option value="0" selected>시도선택</option>
							</select> <select id="gugun" class="form-select me-2" name="gugun">
