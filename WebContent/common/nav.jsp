		...
		<div class="collapse navbar-collapse" id="navbarText">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				...
				<li class="nav-item"><a class="nav-link"
					href="${root}/myTripPlan/index.jsp">나의여행계획</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${root}/hotPlace/index.jsp">핫플자랑하기</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${root}/shareTrip/index.jsp">여행정보공유</a></li>
				<li class="nav-item"><a class="nav-link"
					href="${root}/notice/index.jsp">공지사항</a></li>
			</ul>
			...
			<c:if test="${!empty user}">
				...
				<div id="header_nav_confirm_on">
					<ul class="navbar-nav mb-2 me-2 mb-lg-0">
						<li class="nav-item"><a class="nav-link" aria-current="page"
							href="${root}/UserController?action=view&id=${user.id}">마이페이지</a></li>
						<li class="nav-item"><a class="nav-link" aria-current="page"
