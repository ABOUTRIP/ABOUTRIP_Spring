				...
				<div class="modal-dialog d-flex justify-content-center">
					<div class="modal-content w-75">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel4">새 여행정보 공유하기
							</h5>
					...
					<form>
						...
						<div class="form-outline mb-4">
							<input type="text" id="name4" class="form-control disabled"
								value="안녕하세요 enjoytrip입니다." /> <label class="form-label"
								for="name4">제목</label>
						</div>
			...
			<div class="modal-content w-75">
				...
				<div class="modal-body p-4">
					<form>
						...
						<div class="form-outline mb-4">
							<input type="text" id="name4" class="form-control disabled"
								value="제주도 가면 마라도 꼭 다녀오세요!!" /> <label class="form-label"
								for="name4">제목</label>
						</div>
