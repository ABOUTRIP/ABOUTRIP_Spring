		...
		<div class="container-fluid header bg-white p-0">
			<div
				...
				<div class="col-md-6 p-5 mt-lg-5">
					<h1 class="display-5 animated fadeIn mb-4">나만의 여행계획 짜기</h1>
				...
				<div class="col-md-6 animated fadeIn">
					<img class="img-fluid" src="img/설악산.jpg" alt="" />
				</div>
			</div>
		</div>
		<!-- Header End -->
				...
				<div class="bg_white">
					<div class="row g-5 align-items-center">
						...
						<script type="text/javascript"
							src="//dapi.kakao.com/v2/maps/sdk.js?appkey=478ba7c5d434665bb10ce7e2978bacaa&libraries=services"></script>
					</div>
				</div>
			</div>
		</div>
	...
	<script>
		...
		function getListItem(index, places) {
			...
			var el = document.createElement('li'), itemStr = '<span class="markerbg marker_'
					...
					+ '</h5>'
					+ '<span>'
					+ '<button onclick="draw_position('
					+ places.y
					+ ','
					+ places.x + ')">' + '추가' + '</button>' + '</span>';
		...
		//선택 버튼 클릭시 지도에 그려줄 함수
		function draw_position(y, x) {
			var clickPosition = new kakao.maps.LatLng(y, x);
